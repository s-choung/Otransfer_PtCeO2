...
def main():
    ...
    # Load structures
    trajectory_template = "./output/1_ceo2_al2o3/md_relaxation_ceo2_al2o3_{}.traj"
    ...
    if structures:
        ...
        structures_with_vacancies = generator.generate_vacancy_structures(
            ...
            center_list,
            vacancy_percent=10
        ) # Example with Ce3+ 40% (10% oxygen vacancy)
        
        # Save results
        if structures_with_vacancies:
            print(structures_with_vacancies[0].pbc)
            write('./output/2_structure_reduction/CeO2_40p.traj', structures_with_vacancies)  # small, medium, large CeO2 are saved in .traj as [0, 1, 2]
